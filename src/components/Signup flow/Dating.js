...
export default function DatingFlow() {
    ...
    <>
      ...
      <div className="border-b border-[#E0E0E0] pb-8">
        ...
        <div className="flex flex-col gap-2">
          <button className="w-full flex cursor-pointer items-center gap-4 p-4 rounded-xl border border-[#D8DAE5] bg-[#FAFAFA] hover:bg-[#F5EDFC] hover:border-[#D6AEFF] transition">
            <Image src="/images/men.png" alt="man" width={24} height={24} />
            <span className="font-medium text-[#000000]">Man</span>
          </button>

          <button className="w-full flex items-center cursor-pointer gap-4 p-4 rounded-xl border border-[#D8DAE5] bg-[#FAFAFA] hover:bg-[#F5EDFC] hover:border-[#D6AEFF] transition">
            <Image src="/images/women.png" alt="woman" width={24} height={24} />
            <span className="font-medium text-[#000000]">Woman</span>
          </button>

          <button className="w-full flex items-center gap-4 p-4 mb-10 cursor-pointer rounded-xl border border-[#D8DAE5] bg-[#FAFAFA] hover:bg-[#F5EDFC] hover:border-[#D6AEFF] transition">
            <Image
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 text-[#000000] mb-10 border border-[#E6E6E6] bg-[#FAFAFA] rounded-lg focus:border-[#7B00F7] outline-none"
            />
          </div>
        </div>
      </div>
  ...
  const PreferredGenderStep = () => (
    <>
      ...
      <div className="flex justify-between">
        <button
          onClick={() => setLocalStep(2)}
          className="px-5 py-3 border border-[#CCCCCC] cursor-pointer rounded-lg flex items-center gap-2 text-[#666666]"
        >
        ...
        <button
          ...
          className="px-5 py-3 bg-[#7B00F7] cursor-pointer text-white rounded-lg flex items-center gap-2"
        >
          NEXT <IoIosArrowForward />
        </button>
      </div>
  ...
  const StepSexuality = () => (
    <>
      ...
      <div className="w-full h-1.5 bg-[#D6D6D6] rounded-full mb-6">
        <div className="h-full w-[30%] bg-[#7B00F7] rounded-full"></div>
      </div>
      ...
      <div className="border-b border-[#E0E0E0]">
        ...
        <div className="flex flex-col gap-2">
          <button className="w-full text-[#000000] cursor-pointer flex items-center gap-3 px-4 py-4 rounded-lg border border-[#D8DAE5] bg-[#FAFAFA] text-sm font-medium hover:bg-[#F5EDFC] hover:border-[#D6AEFF]">
            Straight
          </button>
          ...
          <button className="w-full text-[#000000] cursor-pointer flex mb-14 items-center gap-3 px-4 py-4 rounded-lg border border-[#D8DAE5] bg-[#FAFAFA] text-sm font-medium hover:bg-[#F5EDFC] hover:border-[#D6AEFF]">
            Prefer not to say
          </button>
        </div>
      </div>
      <div className="flex justify-between">
        <button
          ...
          className="w-[110px] py-3 flex cursor-pointer items-center justify-center gap-2 rounded-lg text-sm text-[#666666] border border-[#CCCCCC] font-semibold"
        >
    ...
    <>
      ...
      <div className="border-b border-[#E0E0E0]">
        ...
        <div className="flex flex-col gap-3 mb-4">
          <label
            htmlFor="relationshipPreference"
            className="text-sm font-semibold text-[#000D23]"
          >
          ...
          <div className="relative">
            <select
              ...
              className="w-full text-[#000000] px-4 py-3 pr-10 rounded-lg border border-[#E6E6E6] bg-[#FAFAFA] text-sm font-medium appearance-none cursor-pointer focus:outline-none"
            >
      ...
      <div className="border-b border-[#E0E0E0]">
        ...
        <div className="flex flex-col gap-2 mb-3">
          ...
          <input
            ...
            className="w-full text-[#000000] px-4 py-2.5 border bg-[#FAFAFA] border-[#E6E6E6] rounded-lg outline-none  text-sm"
          />
        </div>
        ...
        <div className="flex flex-col gap-2 mb-3">
          ...
          <div className="relative">
            <select
              value={relationshipPreference}
              onChange={(e) => setRelationshipPreference(e.target.value)}
              className="w-full text-[#000000] px-4 py-2.5 pr-10 rounded-lg border border-[#E6E6E6] bg-[#FAFAFA] text-sm appearance-none cursor-pointer focus:outline-none"
            >
              <option value="" disabled>
                Select
              </option>
  ...
  const StepAboutYou = () => (
    <>
      ...
      <div className="border-b border-[#E0E0E0]">
        ...
        <textarea
          placeholder="Type here..."
          className="w-full text-[#000000] h-40 mt-2 px-4 py-3 border bg-[#FAFAFA] border-[#E6E6E6] rounded-lg outline-none
                    text-sm resize-none"
        ></textarea>
      ...
      <div className="mt-6 flex justify-between">
        ...
        <button
          onClick={() => setLocalStep(7)}
          className="w-[110px] cursor-pointer py-3 flex items-center justify-center gap-2 rounded-lg text-sm text-[#666666]
        ...
        <button
          ...
          className="w-[110px] cursor-pointer py-3 flex items-center justify-center gap-2 rounded-lg text-sm text-white font-semibold
                     bg-[#7B00F7]"
        >
          NEXT <IoIosArrowForward className="text-lg" />
        </button>
  ...
  const StepHobbiesandInterests = () => (
    <>
      ...
      <div className="mt-4 sm:mt-6 flex justify-between">
        <button
          onClick={() => setLocalStep(8)}
          className="w-[90px] cursor-pointer sm:w-[110px] py-2 sm:py-3 flex items-center justify-center gap-1 sm:gap-2 rounded-lg
  ...
  const SetpPetPreferance = () => (
    <>
      ...
      <div className="border-b border-[#E0E0E0]">
        ...
        <textarea
          placeholder="Type here..."
          className="w-full text-[#000000] h-30 mt-2 px-4 py-3 mb-14 border bg-[#FAFAFA] border-[#E6E6E6] rounded-lg outline-none
    ...
    <>
      ...
      <div className="mt-6 flex justify-between">
        ...
        <button
          ...
          className="w-[110px] cursor-pointer py-3 flex items-center uppercase justify-center gap-2 rounded-lg text-sm text-white font-semibold
                     bg-[#7B00F7]"
        >
          Complete
        </button>
    ...
    <>
      <div className="flex flex-col items-center justify-center h-full text-center p-6">
        ...
        <button
          ...
          className="w-full sm:w-[194px] cursor-pointer py-3 flex items-center justify-center rounded-lg text-sm text-[#ffffff] font-semibold bg-[#7B00F7] transition duration-300"
        >
          GET STARTED
        </button>
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      {localStep === 4 && <StepSexuality />}
      {localStep === 5 && <StepReletionshipSelect />}
      {localStep === 6 && <StepMatchPreferance />}
      {localStep === 7 && <StepPersonalDetail />}
      {localStep === 8 && <StepAboutYou />}
      {localStep === 9 && <StepHobbiesandInterests />}
      {localStep === 10 && <SetpPetPreferance />}
      {localStep === 11 && <StepAddPhotos />}
      {localStep === 12 && <Stepcomplete />}
    </div>
  );
}
