        ...
        <div className="bg-white rounded-xl">
          ...
          <div className="mt-5 text-sm border border-[#EBE0E4] rounded-xl shadow-sm">
            <div className="flex m-4">
              <span className="text-[#2A2225] font-semibold">Quick Stats</span>
            </div>
            ...
            <div className="flex items-center gap-3 m-4">
              <Image
                ...
                height={20}
              />
              <span className="text-[#000000]">Interior designer at Zesk</span>
            </div>
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow p-5 border border-[#EBE0E4]">
            ...
            <p className="text-sm bg-[#F7F7F7] rounded-lg p-3 text-[#2A2225] leading-relaxed">
              Creative UI/UX Designer passionate about building beautiful apps.
              I love traveling, photography, and exploring new cuisines. Looking
              for someone who shares my love for adventure and meaningful
              conversations.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow p-5 border border-[#EBE0E4]">
            ...
            <div className="flex flex-wrap gap-2">
              {["Photography", "Traveling", "Cooking", "Reading", "Hiking"].map(
                (hobby) => (
                  <span
                    key={hobby}
          ...
          {openGalleryModal && (
            <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
              <div className="bg-white w-[420px] rounded-2xl p-6 relative">
                ...
                <h2 className="text-xl font-bold mb-1 text-[#000000]">Add Your Photos</h2>
